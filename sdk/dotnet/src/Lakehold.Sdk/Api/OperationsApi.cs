...
namespace Lakehold.Sdk.Api
{
    ...
    public interface IOperationsApi : IApi
    {
        ...
        Task<IGetOperationApiResponse> GetOperationAsync(string id, System.Threading.CancellationToken cancellationToken = default);
    ...
    public class OperationsApiEvents
    {
        ...
        internal void ExecuteOnGetOperation(OperationsApi.GetOperationApiResponse apiResponse)
        {
    ...
    public sealed partial class OperationsApi : IOperationsApi
    {
        ...
        partial void FormatGetOperation(ref string id);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private void ValidateGetOperation(string id)
        {
            if (id == null)
        ...
        /// <param name="id"></param>
        private void AfterGetOperationDefaultImplementation(IGetOperationApiResponse apiResponseLocalVar, string id)
        {
            bool suppressDefaultLog = false;
            AfterGetOperation(ref suppressDefaultLog, apiResponseLocalVar, id);
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="id"></param>
        partial void AfterGetOperation(ref bool suppressDefaultLog, IGetOperationApiResponse apiResponseLocalVar, string id);
        ...
        /// <param name="id"></param>
        private void OnErrorGetOperationDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string id)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetOperation(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, id);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="id"></param>
        partial void OnErrorGetOperation(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string id);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetOperationApiResponse"/>&gt;</returns>
        public async Task<IGetOperationApiResponse?> GetOperationOrDefaultAsync(string id, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetOperationAsync(id, cancellationToken).ConfigureAwait(false);
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetOperationApiResponse"/>&gt;</returns>
        public async Task<IGetOperationApiResponse> GetOperationAsync(string id, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetOperation(id);

                FormatGetOperation(ref id);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/api/v1/operations/{id}");
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetOperationApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/operations/{id}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetOperationDefaultImplementation(apiResponseLocalVar, id);
            ...
            {
                OnErrorGetOperationDefaultImplementation(e, "/api/v1/operations/{id}", uriBuilderLocalVar.Path, id);
        ...
        /// </summary>
        public partial class GetOperationApiResponse : Lakehold.Sdk.Client.ApiResponse, IGetOperationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Lakehold.Sdk.Model.PublicApiOperationDto? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Lakehold.Sdk.Model.PublicApiOperationDto>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Lakehold.Sdk.Model.PublicApiOperationDto? result)
            {
                result = null;
