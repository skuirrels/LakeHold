...
inputSpec: /contract/lakehold-v1.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{44679FE8-7E07-42E2-B915-3EA960021C4D}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IDiscoveryApi>();
            IGetApiCapabilitiesApiResponse apiResponse = await api.GetApiCapabilitiesAsync();
            PublicApiCapabilities? model = apiResponse.Ok();
        }
...
## Api Information
- appName: LakeHold Public API
- appVersion: v1
- appDescription: Stable, versioned control-plane and lakehouse API for LakeHold. Send machine credentials as a Bearer token and an Idempotency-Key on retryable mutations.
