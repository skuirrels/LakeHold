...
class SnapshotDto(BaseModel):
    ...
    commit_message: Optional[StrictStr] = Field(alias="commitMessage")
    __properties: ClassVar[List[str]] = ["snapshotId", "committedAt", "schemaVersion", "commitMessage"]
