...
public class SystemSettingsApi {
    ...
    public SystemSettingsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SystemSettingsApi(ApiClient apiClient) {
    ...
    private okhttp3.Call getApiV1SystemSettingsCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v1/system-settings";
    ...
    private okhttp3.Call getApiV1SystemSettingsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getApiV1SystemSettingsCall(_callback);

    }


    private ApiResponse<SystemSettingsDto> getApiV1SystemSettingsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getApiV1SystemSettingsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<SystemSettingsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getApiV1SystemSettingsAsync(final ApiCallback<SystemSettingsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getApiV1SystemSettingsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<SystemSettingsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetApiV1SystemSettingsRequest {

        private APIgetApiV1SystemSettingsRequest() {
        }

        /**
         * Build call for getApiV1SystemSettings
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getApiV1SystemSettings request
       ...
       <caption>Response Details</caption>
         ...
         */
        public SystemSettingsDto execute() throws ApiException {
            ApiResponse<SystemSettingsDto> localVarResp = getApiV1SystemSettingsWithHttpInfo();
            return localVarResp.getData();
        }

        /**
         * Execute getApiV1SystemSettings request with HTTP info returned
         * @return ApiResponse&lt;SystemSettingsDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<SystemSettingsDto> executeWithHttpInfo() throws ApiException {
            return getApiV1SystemSettingsWithHttpInfo();
        }

        /**
         * Execute getApiV1SystemSettings request (asynchronously)
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SystemSettingsDto> _callback) throws ApiException {
            return getApiV1SystemSettingsAsync(_callback);
        }
    }
    ...
    private okhttp3.Call putApiV1SystemSettingsCall(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = updateSystemSettingsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putApiV1SystemSettingsValidateBeforeCall(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'updateSystemSettingsRequest' is set
        if (updateSystemSettingsRequest == null) {
            throw new ApiException("Missing the required parameter 'updateSystemSettingsRequest' when calling putApiV1SystemSettings(Async)");
        }

        return putApiV1SystemSettingsCall(updateSystemSettingsRequest, _callback);

    }


    private ApiResponse<SystemSettingsDto> putApiV1SystemSettingsWithHttpInfo(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = putApiV1SystemSettingsValidateBeforeCall(updateSystemSettingsRequest, null);
        Type localVarReturnType = new TypeToken<SystemSettingsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call putApiV1SystemSettingsAsync(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest, final ApiCallback<SystemSettingsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = putApiV1SystemSettingsValidateBeforeCall(updateSystemSettingsRequest, _callback);
        Type localVarReturnType = new TypeToken<SystemSettingsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIputApiV1SystemSettingsRequest {
        @jakarta.annotation.Nonnull
        private final UpdateSystemSettingsRequest updateSystemSettingsRequest;

        private APIputApiV1SystemSettingsRequest(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest) {
            this.updateSystemSettingsRequest = updateSystemSettingsRequest;
        }

        /**
         * Build call for putApiV1SystemSettings
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute putApiV1SystemSettings request
         * @return SystemSettingsDto
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public SystemSettingsDto execute() throws ApiException {
            ApiResponse<SystemSettingsDto> localVarResp = putApiV1SystemSettingsWithHttpInfo(updateSystemSettingsRequest);
            return localVarResp.getData();
        }

        /**
         * Execute putApiV1SystemSettings request with HTTP info returned
         * @return ApiResponse&lt;SystemSettingsDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<SystemSettingsDto> executeWithHttpInfo() throws ApiException {
            return putApiV1SystemSettingsWithHttpInfo(updateSystemSettingsRequest);
        }

        /**
         * Execute putApiV1SystemSettings request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SystemSettingsDto> _callback) throws ApiException {
            return putApiV1SystemSettingsAsync(updateSystemSettingsRequest, _callback);
        }
    }
     ...
     * 
     * @param updateSystemSettingsRequest  (required)
     ...
     */
    public APIputApiV1SystemSettingsRequest putApiV1SystemSettings(@jakarta.annotation.Nonnull UpdateSystemSettingsRequest updateSystemSettingsRequest) {
        return new APIputApiV1SystemSettingsRequest(updateSystemSettingsRequest);
    }
}
