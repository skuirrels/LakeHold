    ...
    return {
      ...
      '@graph': [
        ...
        organization,
        {
          ...
          description:
            'A feature-rich PostgreSQL, DuckDB, and DuckLake lakehouse you host yourself: tenant-aware catalogs, time travel, change data capture, a versioned API with first-party Java, .NET, Go, and Python source SDKs, and every byte stored as open Parquet.',
