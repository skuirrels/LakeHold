...
public static class CatalogBackup
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var exported = await MetadataExporter.ExportAsync(duckling, destination, cancellationToken)
            .ConfigureAwait(false);

        await WriteManifestAsync(duckling, catalog, destination, exported, now, cancellationToken)
            .ConfigureAwait(false);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var manifest = new BackupManifest
        {
            ...
            MetadataSchema = catalog.ResolvedMetadataSchema,
            Tables = tables,
        };
